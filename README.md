# 🧑‍💻 A clone project work.

A clone of **[Zentry](https://zentry.com/)**
...
Create a visually appealing website inspired by **[Zentry](https://zentry.com/)**, with scroll-triggered animations, geometric transitions, and fascinating video storytelling. Along with that, I've learned how to create a rich, modern feel by emphasizing engaging UI/UX and smooth responsiveness.
...
> All rights to these assets and fonts belong to their respective owners. If you plan to use this project commercially or publicly, please replace these assets and fonts with ones you own or have permission to use.
```
